...
lepus_db_host="172.16.33.209"
lepus_db_port=3306
lepus_db_user="lepus"
lepus_db_password="3c905b43cyy"
lepus_db_database="lepus"

#config mysql server
mysql_client="__mysql__"
mysql_host="127.0.0.1"
mysql_port=__port__
mysql_user="bkpuser"
mysql_password="-XyFagHqeuQr%BRo"
host=__hostip__

#config slowqury
slowquery_dir="/opt/mysql_slowlog/${mysql_port}/"
...
#config server_id
lepus_server_id=`$mysql_client -h$lepus_db_host -P$lepus_db_port -u$lepus_db_user -p$lepus_db_password -BNe "select id from lepus.db_servers_mysql where host='$host' and port=$mysql_port;" 2> /dev/null`
